...
match desafio:
    case 1:
        operações = int(input('Qual desafio de raciocínio você deseja fazer? [1]Soma| [2]Subtração | [3]Multiplicação | [4]Divisão | [5]Cálculo com número binário | [6] Sequência lógica | [7] perguntas de lógica '))
        match operações:
            case 1:
